...
<section id="faq"><div className="wrap">
  ...
  <div className="faq" style={{maxWidth:'820px'}}>
    ...
    <details><summary>Windows or Mac?</summary><p>Both. Setup guides for each are in Module 3, including the fixes for the common Windows issues we&apos;ve solved across 338 students.</p></details>

...
<section id="included"><div className="wrap">
  ...
  <div className="stack" id="pricing">
    <ul>
      ...
      <li><span>Claude Academy badges: Claude 101, Claude Cowork, Claude Code</span><span>issued by Anthropic, USA</span></li>
...
<section><div className="wrap">
  <div className="cert">
    <div className="certcard">
      <div className="t">Digital Services Program · Certificate of Mastery</div>
      <div><div className="nm">DSP AI Agent Mastery<br />Zero to Master</div><p style={{fontFamily:'var(--body)',fontSize:'13px',color:'var(--muted)',marginTop:'8px'}}>Awarded on completion of all 15 modules and a capstone reviewed by the DSP team.</p></div>
    ...
    <div>
      ...
      <p className="md" style={{marginTop:'18px'}}><b>Plus three badges issued by Anthropic — not by us.</b> Module 3 walks you through Claude Academy, the free training run by Anthropic, the US company in San Francisco that builds Claude. You finish holding three of their course completion badges with your own name on them — <b>Claude 101</b>, <b>Claude Cowork</b> and <b>Claude Code</b> — alongside the DSP certificate. DSP students already hold these.</p>
...
<section><div className="wrap">
  ...
  <div style={{marginTop:'56px'}}>
    ...
    <p className="lead" style={{marginBottom:'26px'}}>Claude 101, Claude Cowork and Claude Code. These are their own announcement videos on the DSP channel — open any of them on YouTube and check.</p>

...
// restyled onto the shared .dsp-site design system (site.css); the
// page-specific pieces — console, day rows, FAQ, sticky CTA — live in
...
export const metadata: Metadata = {
  title: {
    absolute: 'AI Agents Bootcamp Pakistan — 7 Days, 5 Live Zoom Classes | DSP Academy',
  },
  description:
  ...
  openGraph: {
    ...
    title: 'AI Agents Bootcamp — 7 Days · 5 Live Classes | DSP Academy',
    description:
...
const courseLd = {
  ...
  '@type': 'Course',
  name: 'AI Agents Bootcamp (Vibe Coding Bootcamp)',
  description:
  ...
  offers: {
    '@type': 'Offer',
    price: String(bootcamp.feePkr),
    priceCurrency: 'PKR',
    availability: 'https://schema.org/InStock',
    url: 'https://www.digitalservicesprogram.com/academy/bootcamp#pricing',
  },
  hasCourseInstance: {
    '@type': 'CourseInstance',
    courseMode: 'online',
    ...
    startDate: bootcamp.nextBatchDate,

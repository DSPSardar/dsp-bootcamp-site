...
const STEPS = [
  { step: 'Learn', name: mastery.shortName, line: `${mastery.modules} modules, one real AI Employee built from an empty folder to a live URL. Self-paced, lifetime access.`, href: '/mastery', go: 'Explore the program' },
